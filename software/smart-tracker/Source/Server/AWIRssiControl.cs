...
{
	/// <summary>
	/// Summary description for AWIRssiControl.
	/// </summary>
	public delegate void SetRSSIProgressBar(short rssi, int index);

	public class AWIRssiControl : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.RSSIListView = new CarTracker.ListViewEx();
			...
			this.TagTypeComboBox.TabIndex = 16;
			...
			this.ResetALLButton.TabIndex = 19;
			...
			this.Name = "AWIRssiControl";
			this.Size = new System.Drawing.Size(904, 584);

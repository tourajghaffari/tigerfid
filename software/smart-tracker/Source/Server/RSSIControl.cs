...
{
	/// <summary>
	/// Summary description for RSSIControl.
	/// </summary>
	
	public delegate void SetRSSIProgressBar(short rssi, int index);
 
	public class RSSIControl : System.Windows.Forms.UserControl
	{
		private ListViewEx RSSIListView;
		...
		public RSSIControl()
		{
			...
			/*foreach (ListViewItem i in RSSIListView.Items)
			{
				...
				RSSIListView.AddEmbeddedControl(pb, 1, i.Index);
			}*/

            //RSSIListView.AddEmbeddedControl(
		...
		private void InitializeComponent()
		{
			...
			this.TagTextBox.Location = new System.Drawing.Point(84, 16);
			...
			this.button1.Location = new System.Drawing.Point(712, 432);
			...
			this.ResetALLButton.Location = new System.Drawing.Point(712, 480);
			...
			this.button3.Location = new System.Drawing.Point(712, 380);
			...
			this.Name = "RSSIControl";
			this.Size = new System.Drawing.Size(892, 596);
			this.Load += new System.EventHandler(this.RSSIControl_Load);
		...
		private void RSSIControl_Load(object sender, System.EventArgs e)
		{
		
		}

		private void RSSIListView_SelectedIndexChanged(object sender, System.EventArgs e)
		{
	...
	#region summaryStruct
	[StructLayout(LayoutKind.Sequential)]
	public struct summaryStruct
	{
		public ushort rdrID;        
		public ushort numRuns;
		public ushort numPass;
		public short highRSSI;
		public short lowRSSI;
		public short aveRSSI;
		public UInt32 numRead;
		public UInt64 rssi;

...
typedef struct date {
  ...
  uint8_t  Day;     /*!< The RTC Calender Day.  This parameter can be any value from 1 to 31. */
  uint8_t  Year;    /*!< The RTC Calender Year. This parameter can be any value from 0 to 99. */
} Date;

...
* v3.3.0              Check race condition on Tamper status
*******************************************************************************/ 
...
{  
#if 1 //{FGK: check for race condition on interrupt status}
	EXTI_ClearITPendingBit(EXTI_IT_Pin3);
#endif
    //i2cPowerOn();  
    tamperIRQHandler();
    //i2cPowerOff();    
#if 0 //{FGK: check for race condition on interrupt status}
	EXTI_ClearITPendingBit(EXTI_IT_Pin3);
#endif
}

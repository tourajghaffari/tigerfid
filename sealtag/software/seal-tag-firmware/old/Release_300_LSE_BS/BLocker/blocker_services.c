...
void clockGpioConfig()
{
   ...
   //---Power, Test    
    ...
    //--- Tamper Bounce Handler
    debounceHandlerConfig();
}

void debounceHandlerConfig(void)
{
    CLK_PeripheralClockConfig(CLK_Peripheral_TIM2, ENABLE);
    SYSCFG_REMAPPinConfig(REMAP_Pin_TIM2TRIGLSE, ENABLE);
    // 1Hz or 1000 ms per tick...
    TIM2_TimeBaseInit(TIM2_Prescaler_128, TIM2_CounterMode_Up, 63);

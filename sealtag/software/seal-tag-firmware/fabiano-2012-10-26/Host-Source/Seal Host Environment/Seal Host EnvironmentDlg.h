...
public:
	...
	CButton btnRTCCalStart;
	CButton btnRTCCalRead;
	CButton btnStopTimer;
	CButton btnReadSerial;
	CButton btnReadBattery;
	CButton btnReadUID;
	CButton btnRead5;
	CButton btnRead1;
	...
	afx_msg void OnBnClickedButtonRtcCalibrateStart();
	afx_msg void OnBnClickedButtonRtcCalibrateRead();
	afx_msg void OnBnClickedButtonSerial_Old();
	afx_msg void OnBnClickedButtonSerial();
    afx_msg void OnBnClickedButtonReadBattery();
    afx_msg void OnBnClickedButtonBattery();
